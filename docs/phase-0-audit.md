...
| ----- | -------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| H1 ✅ | **Firebase v12 RN auth persistence not in typed surface** (§3)       | Session does not survive app restart → Phase 2 acceptance failure                         | Option A (narrow declaration) primary, Option B (custom SecureStore `Persistence`) fallback. **Verified by an actual restart test**, not by absence of type errors                                                                   |
